<script>
  ...
  // core components
  import NotificationDropdown from "/imports/ui/components/Dropdowns/NotificationDropdown.svelte";
  import UserDropdown from "/imports/ui/components/Dropdowns/UserDropdown.svelte";
