<script>
  // core components
  import PagesDropdown from "/imports/ui/components/Dropdowns/PagesDropdown.svelte";

  const logoIsotype = "/assets/img/logo-isotipo.png";
  ...
  <div class="container px-4 mx-auto flex flex-wrap items-center justify-between">
    <div class="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
      <a
        ...
        href="/"
      >
        <img src={logoIsotype} alt="logo" class="isotipo" />
        Mini Guerreros
      </a>
      <!-- <button
    ...
    >
      ...
      <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
        ...
        <li class="flex items-center">
          <a
            class="lg:text-white lg:hover:text-blueGray-200 text-blueGray-700 px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold"
            href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fminiguerreros.cl%2FFundacion-MiniGuerreros%2F%23%2F"
            target="_blank"
          >
        ...
        <li class="flex items-center">
          <a
            class="lg:text-white lg:hover:text-blueGray-200 text-blueGray-700 px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold"
            href="https://twitter.com/intent/tweet?url=https%3A%2F%2Fminiguerreros.cl%2FFundacion-MiniGuerreros%2F&text=Fundación%20Mini%20Guerreros"
            target="_blank"
          >
